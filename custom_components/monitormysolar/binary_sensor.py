...
class QuickChargeBinarySensor(MonitorMySolarEntity, BinarySensorEntity):
    """Whether a quick charge boost is currently active.
    ...
    @property
    def is_on(self):
        # Default to off before the first hold snapshot arrives — a boost that
        # is actually running is picked up seconds later and flips this on.
