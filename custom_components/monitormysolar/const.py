...
ENTITIES = {
        "Lux": {
            ...
            "number": {
                "holdbank2": [
                    {"name": "Active Power", "type": "number", "unique_id": "ActivePowerPercentCMD", "unit": "PERCENT", "min": 0, "max": 100 , "mode": "box"},
                    {"name": "Charge Power Rate", "type": "number", "unique_id": "ChargePowerPercentCMD", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box"},
                    {"name": "Discharge Power Rate", "type": "number", "unique_id": "DischgPowerPercentCMD", "unit": "PERCENT", "min": 0, "max": 100 , "mode": "box"},
                    {"name": "AC Charge Rate", "type": "number", "unique_id": "ACChgPowerCMD", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box"},
                    {"name": "AC Charge SOC Limit", "type": "number", "unique_id": "ACChgSOCLimit", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "class": "BATTERY"},
                    {"name": "Charge First Rate", "type": "number", "unique_id": "ChgFirstPowerCMD", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box"},
                    {"name": "Charge First SOC Limit", "type": "number", "unique_id": "ChgFirstSOCLimit", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box"},
                ],
                "gridboss_holdbank2": [
                    {"name": "Generator Warmup Time", "type": "number", "unique_id": "Generator_Warmup", "unit": "s", "min": 0, "max": 600, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "Generator Cool Down Time", "type": "number", "unique_id": "Generator_CoolDown", "unit": "s", "min": 0, "max": 600, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "Generator Exercise Period", "type": "number", "unique_id": "Generator_Exercise_Period", "unit": "d", "min": 0, "max": 365, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad1 Start SOC", "type": "number", "unique_id": "SmartLoad1_StartSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad1 End SOC", "type": "number", "unique_id": "SmartLoad1_EndSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad2 Start SOC", "type": "number", "unique_id": "SmartLoad2_StartSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad2 End SOC", "type": "number", "unique_id": "SmartLoad2_EndSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad3 Start SOC", "type": "number", "unique_id": "SmartLoad3_StartSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad3 End SOC", "type": "number", "unique_id": "SmartLoad3_EndSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad4 Start SOC", "type": "number", "unique_id": "SmartLoad4_StartSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad4 End SOC", "type": "number", "unique_id": "SmartLoad4_EndSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad1 Start Voltage", "type": "number", "unique_id": "SmartLoad1_StartVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad1 End Voltage", "type": "number", "unique_id": "SmartLoad1_EndVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad2 Start Voltage", "type": "number", "unique_id": "SmartLoad2_StartVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad2 End Voltage", "type": "number", "unique_id": "SmartLoad2_EndVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad3 Start Voltage", "type": "number", "unique_id": "SmartLoad3_StartVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad3 End Voltage", "type": "number", "unique_id": "SmartLoad3_EndVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad4 Start Voltage", "type": "number", "unique_id": "SmartLoad4_StartVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad4 End Voltage", "type": "number", "unique_id": "SmartLoad4_EndVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple1 Start SOC", "type": "number", "unique_id": "ACcouple1_StartSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple1 End SOC", "type": "number", "unique_id": "ACcouple1_EndSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple2 Start SOC", "type": "number", "unique_id": "ACcouple2_StartSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple2 End SOC", "type": "number", "unique_id": "ACcouple2_EndSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple3 Start SOC", "type": "number", "unique_id": "ACcouple3_StartSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple3 End SOC", "type": "number", "unique_id": "ACcouple3_EndSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple4 Start SOC", "type": "number", "unique_id": "ACcouple4_StartSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple4 End SOC", "type": "number", "unique_id": "ACcouple4_EndSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple1 Start Voltage", "type": "number", "unique_id": "ACcouple1_StartVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple1 End Voltage", "type": "number", "unique_id": "ACcouple1_EndVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple2 Start Voltage", "type": "number", "unique_id": "ACcouple2_StartVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple2 End Voltage", "type": "number", "unique_id": "ACcouple2_EndVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple3 Start Voltage", "type": "number", "unique_id": "ACcouple3_StartVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple3 End Voltage", "type": "number", "unique_id": "ACcouple3_EndVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple4 Start Voltage", "type": "number", "unique_id": "ACcouple4_StartVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple4 End Voltage", "type": "number", "unique_id": "ACcouple4_EndVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad1 Shedding Start PV Power", "type": "number", "unique_id": "SmartLoad1_SheddingStartPv_Power", "unit": "W", "min": 0, "max": 10000, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad2 Shedding Start PV Power", "type": "number", "unique_id": "SmartLoad2_SheddingStartPv_Power", "unit": "W", "min": 0, "max": 10000, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad3 Shedding Start PV Power", "type": "number", "unique_id": "SmartLoad3_SheddingStartPv_Power", "unit": "W", "min": 0, "max": 10000, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad4 Shedding Start PV Power", "type": "number", "unique_id": "SmartLoad4_SheddingStartPv_Power", "unit": "W", "min": 0, "max": 10000, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad1 Shedding Start SOC", "type": "number", "unique_id": "SmartLoad1_SheddingStartSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad1 Shedding End SOC", "type": "number", "unique_id": "SmartLoad1_SheddingEndSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad2 Shedding Start SOC", "type": "number", "unique_id": "SmartLoad2_SheddingStartSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad2 Shedding End SOC", "type": "number", "unique_id": "SmartLoad2_SheddingEndSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad3 Shedding Start SOC", "type": "number", "unique_id": "SmartLoad3_SheddingStartSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad3 Shedding End SOC", "type": "number", "unique_id": "SmartLoad3_SheddingEndSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad4 Shedding Start SOC", "type": "number", "unique_id": "SmartLoad4_SheddingStartSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad4 Shedding End SOC", "type": "number", "unique_id": "SmartLoad4_SheddingEndSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad1 Shedding Start Voltage", "type": "number", "unique_id": "SmartLoad1_SheddingStartVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad1 Shedding End Voltage", "type": "number", "unique_id": "SmartLoad1_SheddingEndVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad2 Shedding Start Voltage", "type": "number", "unique_id": "SmartLoad2_SheddingStartVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad2 Shedding End Voltage", "type": "number", "unique_id": "SmartLoad2_SheddingEndVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad3 Shedding Start Voltage", "type": "number", "unique_id": "SmartLoad3_SheddingStartVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad3 Shedding End Voltage", "type": "number", "unique_id": "SmartLoad3_SheddingEndVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad4 Shedding Start Voltage", "type": "number", "unique_id": "SmartLoad4_SheddingStartVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad4 Shedding End Voltage", "type": "number", "unique_id": "SmartLoad4_SheddingEndVolt", "unit": "V", "min": 40, "max": 60, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "Flash 50/60Hz", "type": "number", "unique_id": "Flash_5060hz", "unit": "", "min": 0, "max": 1, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "NEC 120 Current Limit", "type": "number", "unique_id": "NEC_120CurrLimit", "unit": "A", "min": 0, "max": 200, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                ],
                "holdbank3": [
                    {"name": "Force Discharge Power Rate", "type": "number", "unique_id": "ForcedDischgPowerCMD", "unit": "PERCENT", "min": 0, "max": 100 , "mode": "box"},
                    {"name": "Force Discharge SOC Limit", "type": "number", "unique_id": "ForcedDischgSOCLimit", "unit": "PERCENT", "min": 0, "max": 100 , "mode": "box"},
                    {"name": "Discharge Current DC(A)", "type": "number", "unique_id": "DischgCurr", "unit": "A", "min": 0, "max": 140, "firmware_max_values": {"FAAA": 250, "FAAB": 250, "EAAA": 195, "EAAB": 195, "HAAA": 195, "ccaa": 250, "ceaa": 250, "AAAA": 78, "AAAB": 78, "BAAA": 78, "BAAB": 78}, "mode": "box"},
                    {"name": "Charge Current DC(A)", "type": "number", "unique_id": "ChargeCurr", "unit": "A", "min": 0, "max": 140, "firmware_max_values": {"FAAA": 250, "FAAB": 250, "EAAA": 195, "EAAB": 195, "HAAA": 195, "ccaa": 250, "ceaa": 250, "AAAA": 78, "AAAB": 78, "BAAA": 78, "BAAB": 78}, "mode": "box"},
                    {"name": "Lead acid Charge Rate (A)", "type": "number", "unique_id": "ChargeRate", "unit": "A", "min": 0, "max": 140, "firmware_max_values": {"FAAA": 250, "FAAB": 250, "EAAA": 195, "EAAB": 195, "HAAA": 195, "ccaa": 250, "ceaa": 250, "AAAA": 78, "AAAB": 78, "BAAA": 78, "BAAB": 78}, "mode": "box", "native_unit": "A", "class": "CURRENT"},
                    {"name": "Lead Acid Discharge Rate (A)", "type": "number", "unique_id": "DischgRate", "unit": "A", "min": 0, "max": 140, "firmware_max_values": {"FAAA": 250, "FAAB": 250, "EAAA": 195, "EAAB": 195, "HAAA": 195, "ccaa": 250, "ceaa": 250, "AAAA": 78, "AAAB": 78, "BAAA": 78, "BAAB": 78}, "mode": "box", "native_unit": "A", "class": "CURRENT"},
                    {"name": "Battery Discharge Start Point (W)", "type": "number", "unique_id": "PtoUserStartdischg", "unit": "W", "min": 1, "max": 50 , "mode": "box", "native_unit": "W", "class": "POWER"},
                    {"name": "Battery Charge Start Point (W)", "type": "number", "unique_id": "PtoUserStartchg", "unit": "W", "min": -50, "max": 1, "mode": "box", "native_unit": "W", "class": "POWER"},
                    {"name": "CT Offset (W)", "type": "number", "unique_id": "wCT_PowerOffset", "unit": "W", "min": 0, "max": 1000 , "mode": "box", "native_unit": "W", "class": "POWER"},
                    {"name": "Export Power (%)", "type": "number", "unique_id": "MaxBackFlow", "unit": "W", "min": 0, "max": 200 , "mode": "box", "state_class": SensorStateClass.MEASUREMENT, "unit_of_measurement": PERCENTAGE},
                    {"name": "On-grid Discharge Cut-off SOC Limit", "type": "number", "unique_id": "EOD", "unit": "PERCENT", "min": 0, "max": 90, "mode": "box"},
                ],
                "holdbank4": [
                    {"name": "Off-grid Discharge Cut-off SOC Limit", "type": "number", "unique_id": "SOCLowLimitForESPSDischg", "unit": "PERCENT", "min": 0, "max": 90, "mode": "box"},
                    {"name": "AC Charge Start (SOC)", "type": "number", "unique_id": "ACChgStartSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box"},
                    {"name": "AC Charge End (SOC)", "type": "number", "unique_id": "ACChgEndSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box"},
                    {"name": "AC Charge Start (Voltage)", "type": "number", "unique_id": "ACChgStartVolt", "step": 0.1, "unit": "VOLT", "min": 38.5, "max": 52, "mode": "box"},
                    {"name": "AC Charge End (Voltage)", "type": "number", "unique_id": "ACChgEndVolt", "step": 0.1, "unit": "VOLT", "min": 48, "max": 59, "mode": "box"},
                    {"name": "Max Grid Input Power", "type": "number", "unique_id": "MaxGridInputPower", "unit": "kW", "min": 0, "max": 24, "mode": "box", "step": 0.1},
                    {"name": "Generator Ratied Input Power", "type": "number", "unique_id": "GenRatePower", "unit": "kW", "min": 0, "max": 24, "mode": "box", "step": 0.1, "allowed_firmware_codes": ["HAAA", "FAAA", "FAAB", "ccaa", "ceaa"]},
                    {"name": "Generator Charge Start Voltage", "type": "number", "unique_id": "GenChgStartVolt", "unit": "V", "min": 40, "max": 56, "mode": "box", "step": 0.1, "allowed_firmware_codes": ["HAAA", "FAAA", "FAAB", "ccaa", "ceaa"]},
                    {"name": "Generator Charge End Voltage", "type": "number", "unique_id": "GenChgEndVolt", "unit": "V", "min": 50, "max": 60, "mode": "box", "step": 0.1, "allowed_firmware_codes": ["HAAA", "FAAA", "FAAB", "ccaa", "ceaa"]},
                    {"name": "Generator Charge Start SOC", "type": "number", "unique_id": "GenChgStartSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "step": 1, "allowed_firmware_codes": ["HAAA", "FAAA", "FAAB", "ccaa", "ceaa"]},
                    {"name": "Generator Charge End SOC", "type": "number", "unique_id": "GenChgEndSOC", "unit": "PERCENT", "min": 0, "max": 100, "mode": "box", "step": 1, "allowed_firmware_codes": ["HAAA", "FAAA", "FAAB", "ccaa", "ceaa"]},
                    {"name": "Max Generator Charge Battery Current", "type": "number", "unique_id": "MaxGenChgBatCurr", "unit": "A", "min": 0, "max": 140, "firmware_max_values": {"FAAA": 250, "FAAB": 250, "HAAA": 195, "ccaa": 250, "ceaa": 250}, "mode": "box", "step": 1, "allowed_firmware_codes": ["HAAA", "FAAA", "FAAB", "ccaa", "ceaa"]},
                    {"name": "Generator Charge Start Current", "type": "number", "unique_id": "GenChgStartCurr", "unit": "A", "min": 0, "max": 140, "firmware_max_values": {"FAAA": 250, "FAAB": 250, "HAAA": 195, "ccaa": 250, "ceaa": 250}, "mode": "box", "step": 1, "allowed_firmware_codes": ["HAAA", "FAAA", "FAAB", "ccaa", "ceaa"]}
                ],
                "holdbank6": [
                    {"name": "System Charge SOC Limit %", "type": "number", "unique_id": "BatStopChgSOC", "unit": "PERCENT", "min": 0, "max": 101, "mode": "box", "allowed_firmware_codes": ["HAAA", "FAAA", "FAAB", "ccaa", "ceaa"]},
                    {"name": "System Charge Volt limit (v)", "type": "number", "unique_id": "BatStopChgVolt", "unit": "V", "min": 40, "max": 56, "mode": "box", "allowed_firmware_codes": ["HAAA", "FAAA", "FAAB", "ccaa", "ceaa"]},
                    {"name": "Stop Dischage (Voltage)", "type": "number", "unique_id": "ForceDichgEndVolt", "unit": "V", "min": 40, "max": 56, "mode": "box"},
                ],
            },
            "select": {
                "holdbank3": [
