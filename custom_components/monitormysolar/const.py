...
ENTITIES = {
        "Lux": {
            ...
            "number": {
                "holdbank2": [
                    {"name": "Active Power", "type": "number", "unique_id": "ActivePowerPercentCMD", "unit": "%", "min": 0, "max": 100 , "mode": "box"},
                    {"name": "Charge Power Rate", "type": "number", "unique_id": "ChargePowerPercentCMD", "unit": "%", "min": 0, "max": 100, "mode": "box"},
                    {"name": "Discharge Power Rate", "type": "number", "unique_id": "DischgPowerPercentCMD", "unit": "%", "min": 0, "max": 100 , "mode": "box"},
                    {"name": "AC Charge Rate", "type": "number", "unique_id": "ACChgPowerCMD", "unit": "%", "min": 0, "max": 100, "mode": "box"},
                    {"name": "AC Charge SOC Limit", "type": "number", "unique_id": "ACChgSOCLimit", "unit": "%", "min": 0, "max": 100, "mode": "box", "class": "BATTERY"},
                    {"name": "Charge First Rate", "type": "number", "unique_id": "ChgFirstPowerCMD", "unit": "%", "min": 0, "max": 100, "mode": "box"},
                    {"name": "Charge First SOC Limit", "type": "number", "unique_id": "ChgFirstSOCLimit", "unit": "%", "min": 0, "max": 100, "mode": "box"},
                ],
                "gridboss_holdbank2": [
                    ...
                    {"name": "SmartLoad1 Start SOC", "type": "number", "unique_id": "SmartLoad1_StartSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad1 End SOC", "type": "number", "unique_id": "SmartLoad1_EndSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad2 Start SOC", "type": "number", "unique_id": "SmartLoad2_StartSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad2 End SOC", "type": "number", "unique_id": "SmartLoad2_EndSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad3 Start SOC", "type": "number", "unique_id": "SmartLoad3_StartSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad3 End SOC", "type": "number", "unique_id": "SmartLoad3_EndSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad4 Start SOC", "type": "number", "unique_id": "SmartLoad4_StartSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad4 End SOC", "type": "number", "unique_id": "SmartLoad4_EndSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    ...
                    {"name": "ACcouple1 Start SOC", "type": "number", "unique_id": "ACcouple1_StartSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple1 End SOC", "type": "number", "unique_id": "ACcouple1_EndSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple2 Start SOC", "type": "number", "unique_id": "ACcouple2_StartSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple2 End SOC", "type": "number", "unique_id": "ACcouple2_EndSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple3 Start SOC", "type": "number", "unique_id": "ACcouple3_StartSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple3 End SOC", "type": "number", "unique_id": "ACcouple3_EndSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple4 Start SOC", "type": "number", "unique_id": "ACcouple4_StartSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "ACcouple4 End SOC", "type": "number", "unique_id": "ACcouple4_EndSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    ...
                    {"name": "SmartLoad1 Shedding Start SOC", "type": "number", "unique_id": "SmartLoad1_SheddingStartSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad1 Shedding End SOC", "type": "number", "unique_id": "SmartLoad1_SheddingEndSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad2 Shedding Start SOC", "type": "number", "unique_id": "SmartLoad2_SheddingStartSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad2 Shedding End SOC", "type": "number", "unique_id": "SmartLoad2_SheddingEndSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad3 Shedding Start SOC", "type": "number", "unique_id": "SmartLoad3_SheddingStartSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad3 Shedding End SOC", "type": "number", "unique_id": "SmartLoad3_SheddingEndSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad4 Shedding Start SOC", "type": "number", "unique_id": "SmartLoad4_SheddingStartSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                    {"name": "SmartLoad4 Shedding End SOC", "type": "number", "unique_id": "SmartLoad4_SheddingEndSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "allowed_firmware_codes": ["IAAB"]},
                ...
                "holdbank3": [
                    {"name": "Force Discharge Power Rate", "type": "number", "unique_id": "ForcedDischgPowerCMD", "unit": "%", "min": 0, "max": 100 , "mode": "box"},
                    {"name": "Force Discharge SOC Limit", "type": "number", "unique_id": "ForcedDischgSOCLimit", "unit": "%", "min": 0, "max": 100 , "mode": "box"},
                    ...
                    {"name": "On-grid Discharge Cut-off SOC Limit", "type": "number", "unique_id": "EOD", "unit": "%", "min": 0, "max": 90, "mode": "box"},
                ],
                "holdbank4": [
                    {"name": "Off-grid Discharge Cut-off SOC Limit", "type": "number", "unique_id": "SOCLowLimitForESPSDischg", "unit": "%", "min": 0, "max": 90, "mode": "box"},
                    {"name": "AC Charge Start (SOC)", "type": "number", "unique_id": "ACChgStartSOC", "unit": "%", "min": 0, "max": 100, "mode": "box"},
                    {"name": "AC Charge End (SOC)", "type": "number", "unique_id": "ACChgEndSOC", "unit": "%", "min": 0, "max": 100, "mode": "box"},
                    {"name": "AC Charge Start (Voltage)", "type": "number", "unique_id": "ACChgStartVolt", "step": 0.1, "unit": "V", "min": 38.5, "max": 52, "mode": "box"},
                    {"name": "AC Charge End (Voltage)", "type": "number", "unique_id": "ACChgEndVolt", "step": 0.1, "unit": "V", "min": 48, "max": 59, "mode": "box"},
                    ...
                    {"name": "Generator Charge Start SOC", "type": "number", "unique_id": "GenChgStartSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "step": 1, "allowed_firmware_codes": ["HAAA", "FAAA", "FAAB", "ccaa", "ceaa"]},
                    {"name": "Generator Charge End SOC", "type": "number", "unique_id": "GenChgEndSOC", "unit": "%", "min": 0, "max": 100, "mode": "box", "step": 1, "allowed_firmware_codes": ["HAAA", "FAAA", "FAAB", "ccaa", "ceaa"]},
                ...
                "holdbank6": [
                    {"name": "System Charge SOC Limit %", "type": "number", "unique_id": "BatStopChgSOC", "unit": "%", "min": 0, "max": 101, "mode": "box", "allowed_firmware_codes": ["HAAA", "FAAA", "FAAB", "ccaa", "ceaa"]},
